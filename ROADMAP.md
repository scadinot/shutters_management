...
|---|---|---|
| [Statut actuel](#statut-actuel) | Version courante v0.4.9 — voir CHANGELOG pour l'historique | livré |
...
La version courante est **v0.4.9**. Pour la liste des fonctionnalités
