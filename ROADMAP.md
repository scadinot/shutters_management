...
|---|---|---|
| [Statut actuel](#statut-actuel) | Version courante v0.3.2 — voir CHANGELOG pour l'historique | livré |
...
La version courante est **v0.3.2**. Pour la liste des fonctionnalités
