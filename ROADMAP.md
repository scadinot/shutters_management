...
|---|---|---|
| [Statut actuel](#statut-actuel) | Version courante v0.2.3 — voir CHANGELOG pour l'historique | livré |
...
La version courante est **v0.2.3**. Pour la liste des fonctionnalités
